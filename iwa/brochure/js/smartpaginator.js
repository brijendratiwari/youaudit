        ...
        smartpaginator: function (options) {
            ...
            return this.each(function () {
                ...
                function showLabels(pageIndex) {
                    container.find('span').remove();
                    $("#projectsControl").children('.pageInfo').remove();
                    $("#tasksControl").children('.pageInfo').remove();
                    ...
                    container.append($('<span/>').append($('<b/>').text(pageIndex * settings.recordsperpage + 1)))
                                     ...
                                     setTimeout(function(){
                                        $("#projectsControl").children('span').wrapAll('<div class="pageInfo" />');
                                        $("#tasksControl").children('span').wrapAll('<div class="pageInfo" />');
                                    });
                }
