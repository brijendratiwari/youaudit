<div class="box">
    ...
    <p><strong>Note:</strong> <em>You will not be able to delete sites that have active items linked to it.</em></p>
    
    <p>You are deleting <strong><?php echo $strName; ?></strong></p>
    <?php echo form_open('sites/deleteone/'.$intSiteId.'/', array('id'=>'delete_faculty_form')); ?>