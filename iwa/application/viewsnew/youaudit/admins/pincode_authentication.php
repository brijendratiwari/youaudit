    <h2>YouAudit Pin-Number</h2>
    
    <?php echo validation_errors(); ?>
    <form action="<?php echo base_url().'youaudit/pincodeAuthentication';?>" method="POST" id="pin_form" >
	...
	<label for="password">Your Pin Number</label>
       ...
       <input type="hidden" name="username" value="<?php echo $this->session->userdata('sysAdminUserName');?>">
    </div>
