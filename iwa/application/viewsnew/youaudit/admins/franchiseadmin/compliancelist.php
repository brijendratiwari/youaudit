...
<div class="box_content">
    <div class="ver_tabs" style="">
        <a  href="<?php echo base_url("youaudit/franchise_admins/complianceChecksForFranchise/$masterid"); ?>"><span>Customer Template</span></a>
        <a class="active" href="<?php echo base_url("youaudit/franchise_admins/compliancesListForFranchise/$masterid"); ?>"><span>List Of Compliance Check </span></a>
    </div>  
            ...
            <table id="compliance_list" class="list_table">
                <thead>
                    <tr>
                        ...
                        <th hidden=""></th>
                        <th hidden=""></th>
                        <th data-export="false" class="right action">Actions</th>
                        <th hidden=""></th>
                    </tr>
                </thead>
                <tfoot>
                    ...
                    <tr data-value="<?php print $test['cid']; ?>">
                      ...
                      <td hidden=""><?php print $test['tasks']; ?></td>
                       <td class="right action">
                            ...
                            <a  href="javascript:void(0)" data-toggle="modal" onclick="deleteTemplate(this)" data-id="<?php echo $test['cid']; ?>"data-href="<?php echo site_url() . 'youaudit/franchise_admins/removeTemplate/' . $test['cid'].'/'.$masterid; ?>"><img src="<?php echo 'http://' . $_SERVER['HTTP_HOST']; ?>/img/icons/16/erase.png" title="Remove" alt="Remove"></a>
    ...
    <div class="modal fade" id="complianceEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo base_url("youaudit/franchise_admins/editTemplateCompliance/$masterid")?>" method="post">
...
<div class="modal fade" id="multiComplianceEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo base_url("youaudit/franchise_admins/editMultiTemplateCompliance/$masterid")?>" method="post">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
