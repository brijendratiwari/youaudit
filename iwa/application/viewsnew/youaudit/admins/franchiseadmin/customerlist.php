...
//                    rangelength: "Please enter a value between 3 and 4 characters long."
        ...
        $("#username").on("keyup blur", function() {
            ...
            $.ajax({
                type: "POST",
                url: base_url_str + "youaudit/franchise_admins/check_franchiseCustomerUsername",
                data: {
                    'username': username
                },
        ...
        $("#edit_customer_account_form").validate({
            ...
            messages: {
                ...
                edit_contact_phone: "Please Enter Valid Phone",
                edit_contact_name: "Please Enter Contact Number",
...
//            $.ajax({
//                type: "POST",
//                url: base_url_str + "youaudit/franchise_admins/generateRandomString",
//                success: function (msg) {
...
//        });
        ...
        $("body").on("click", ".edit_franchise_customer_data", function() {
            $(".result").empty();
            var base_url_str = $("#base_url").val();
            var franchise_customer_id = $(this).attr("data_customer_id");

            $.ajax({
                type: "POST",
                url: base_url_str + "youaudit/franchise_admins/getEditFranchiseCustomerdata",
                data: {
                    'id': franchise_customer_id
                },
    ...
    <div class="col-lg-9" style="margin-top: 35px;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <a style="margin-left:500px;" href='<?php echo base_url("youaudit/franchise_admins/exportFranchiseCusPdf/PDF/$masterid"); ?>' class="btn btn-primary btn-xs icon-with-text" type="button" id="b1"><i class="fa  fa-file-pdf-o"></i>
                    <b> Export PDF</b></a>
                <a href='<?php echo base_url("youaudit/franchise_admins/exportFranchiseCusPdf/CSV/$masterid"); ?>' class="btn btn-primary btn-xs icon-with-text" type="button"><i class="fa fa-file-word-o"></i>
                    <b>Export CSV</b></a>
            </div>
        </div>
    </div>
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive">
                <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
                    <table id="Franchise_Customer_Datatable" class="table table-bordered" width="100%" cellspacing="0">
                        <thead>
                            <tr class="access">
