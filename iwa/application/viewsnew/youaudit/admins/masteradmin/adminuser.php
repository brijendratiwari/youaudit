...
//
 $("#username").on("keyup blur", function () {
            ...
            $.ajax({
                type: "POST",
                url: base_url_str + "youaudit/master_admins/checkMasterAdminUsername",
                data: {
                    'username': username
                },
    ...
    <div class="col-lg-9" style="margin-top: 35px;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
               ...
               <a style="margin-left:550px;" href="<?php echo base_url() . 'youaudit/master_admins/exportAdminUser/PDF/'.$masterid ?>" class="btn btn-primary btn-xs icon-with-text " type="button" id="b1"><i class="fa  fa-file-pdf-o"></i>
                    <b> Export PDF</b></a>
                <a  class="btn btn-primary btn-xs icon-with-text" href="<?php echo base_url() . 'youaudit/master_admins/exportAdminUser/CSV/'.$masterid ?>" type="button"><i class="fa fa-file-word-o"></i>
                    <b>Export CSV</b></a>
            </div>
        </div>
    </div>
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
                    <table id="Adminuser_datatable" class="table table-striped table-bordered table-hover" width="100%" cellspacing="0">
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="add_admin_user_form" class="modal fade" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url('youaudit/addAdminUser') ?>" method="post" id="add_admin_user_ac">
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="change_password_model" class="modal fade" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url('youaudit/changeAdminUserPassword') ?>" method="POST" id="updatepassword">
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit_admin_user_form" class="modal fade" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url('youaudit/editAdminUser') ?>" method="post" id="edit_admin_user_ac">
                <div class="modal-body" style="height:250px">
