...
//                $('#tokenfield-typeahead').tokenfield('createToken', {value: arr[0], label: arr[1]});
    ...
    function beforeTestAdd() {
        ...
        if (comName.trim() == '' || comCat.trim() == '' || comFre.trim() == '') {
            ...
            $('input#Compliance_check_name[value=""]').effect('shake', {times: 3, distance: 5}, "slow");
            $('#mandatory[value=""]').effect('shake', {times: 3, distance: 5}, "fast");
            $('#frequency[value=""]').effect('shake', {times: 3, distance: 5}, "fast");
            return false;
        }
    ...
    <div class="content_main">
        <div class="compliance_box_top" style="min-height: 500px;">
            <div id="compliance_snapshot">
                <?php echo form_open('admins/complianceChecks/', array('id' => 'add_compliance', 'action' => 'post')); ?>
                                ...
                                <?php foreach ($allTests as $test) { ?>
                                    <tr>
                                        ...
                                        <td class="right action">
                                            <a  href="#EditTaskModal" data-toggle="modal" onclick="editTaskSetup(this)" data-id="<?php echo $test['id']; ?>"data-href="<?php echo site_url() . 'compliance/editTaskAdmins/' . $test['id']; ?>"><img src="<?php echo 'http://' . $_SERVER['HTTP_HOST']; ?>/img/icons/16/modify.png" title="Edit" alt="Edit"></a>
                                            <a  href="javascript:void(0)" data-toggle="modal" onclick="deleteTask(this)" data-id="<?php echo $test['id']; ?>"data-href="<?php echo site_url() . 'compliance/removeTaskAdmins/' . $test['id']; ?>"><img src="<?php echo 'http://' . $_SERVER['HTTP_HOST']; ?>/img/icons/16/erase.png" title="Remove" alt="Remove"></a>
                                        </td>
                                    </tr>
<?php } ?>
                            </thead>
...
<?php echo form_open('compliance/addTaskAdmins/', array('id' => 'add_new_task')); ?>
