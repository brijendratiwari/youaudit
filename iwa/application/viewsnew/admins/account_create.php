<div class="box">
    <div class="heading">
        ...
        <div class="buttons">
            <a class="button" onclick="$('#create_account').submit();">Save</a>
        </div>
    </div>
   ...
   <div class="tabs">
    ...
    <?php echo form_open('admins/createaccount/', array('id'=>'create_account')); ?>
    ...
    <div class="form_row">
        <label for="account_contactpassword">Password for First User*</label> 
	<input type="input" name="account_contactpassword" value="" />
	<?php echo form_error('account_contactpassword'); ?>
	<br />
    </div>
