        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-3 pull-right">
                    <a class="btn btn-primary btn-xs icon-with-text round pull-left" href="<?php echo base_url('admins/exportProfilePdf/PDF'); ?>" type="button" id="b1"><i class="fa  fa-file-pdf-o"></i>
                        <b> Export PDF</b></a>
                    <a class="btn btn-primary btn-xs icon-with-text round pull-left" href="<?php echo base_url('admins/exportProfilePdf/CSV'); ?>" type="button"><i class="fa fa-file-word-o"></i>
                        <b>Export CSV</b></a>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-lg-12">
        <h5 class="page-header"><?php echo strtoupper($this->session->userdata('ParentAccountName')); ?> / PROFILES</h5>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="col-lg-4">
                            ...
                            <tbody id="profile_body">
                                <?php foreach ($profilelist as $profile) {
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="action-w"><a  id="edit_adminuser_id_<?php echo $profile->profile_id; ?>" href="#edit_profile" title="Edit" data_profilename="<?php echo $profile->profile_name; ?>" data_adminuser_id="<?php echo $profile->profile_id; ?>" class="edit"><i class="glyphicon glyphicon-edit franchise-i"></i></a>Edit</span><span class="action-w"><a href="#" class="view_profile" title="View" profile_name="<?php echo $profile->profile_name; ?>" profile_id="<?php echo $profile->profile_id; ?>"><i class="glyphicon glyphicon-eye-open franchise-i"></i></a>View</span></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
            ...
            <!--<div class="table-responsive">-->
            <!--            <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-customerlist">
                            <form action="<?php echo base_url('admins/add_profile'); ?>" method="post" id="add_profile_form">
        ...
        <div class="col-lg-8" id="edit_form">
            <form action="<?php echo base_url('admins/editProfile'); ?>" method="post" id="edit_profile_form">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group ">
                            ...
                            <div class="col-md-4" ><input style="float:right" type="submit" disabled="" class="btn btn-info" value="Save"></div>
                        </div> <!-- /.form-group -->
                        <input type="hidden" name="adminuser_id" id="adminuser_id_1" style="visibility:hidden;" readonly/>
                        <div class="col-md-4">
                            <div class="col-md-2">Show</div>
                            <div class="col-md-2"><select id="profile_limit" disabled="">
            ...
            <form action="<?php echo base_url('admins/add_profile'); ?>" method="post" id="add_profile_form">
                ...
                <div class="form-group col-md-12" id="profileadd">
                    <div class="col-md-2" id="profile_owner">
                        ...
                        <div class="multi-field"><input type="hidden" name="owner" value="1"><input size="9" class="form-control prof pull-left" name="owner_name1" id="owners"><button type="button" class="add-owner btn-xs btn-primary addp pull-right"><i class="fa fa-plus"></i></button></div>
                    </div>
                    <div class="col-md-2" id="profile_category">
                        <div class="profilehead">Categories</div>
                        <input type="hidden" name="category" value="1"><input size="9" class="form-control prof pull-left" name="category_name1" id="categories"><button type="button" class="add-category btn-xs btn-primary addp pull-right"><i class="fa fa-plus"></i></button>
                    </div>
                    <div class="col-md-2" id="profile_item">
                        <div class="profilehead">Item</div>
                        <input type="hidden" name="manu" value="1"><input size="9" class="form-control prof pull-left" name="manu_name1" id="manus"><button type="button" class="add-manu btn-xs btn-primary addp pull-right"><i class="fa fa-plus"></i></button>
                    </div>
                    <div class="col-md-2" id="profile_manufacturer">
                        <div class="profilehead">Manufacturer</div> 
                        <input type="hidden" name="manufacturer" value="1"><input size="9" class="form-control prof pull-left" name="manufacturer_name1" id="manufactures"><button type="button" class="add-manufacturer btn-xs btn-primary addp pull-right"><i class="fa fa-plus"></i></button>
                    </div>
...
<!-- Modal For Add User -->
<!--<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="add_profile" class="modal fade" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                <h4 id="myModalLabel" class="modal-title">Add Profile</h4>
            </div>

            <form action="<?php echo base_url('master/add_profile'); ?>" method="post" id="add_profile_form">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" type="submit" id="save_button">Add</button>
                </div>
            </form>
        </div>
...
<!--<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit_profile" class="modal fade" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times;</button>
                <h4 id="myModalLabel" class="modal-title">Edit Profile</h4>
            </div>
                ...
                <div class="modal-body">
                    <div class="form-group col-md-12">
                        <div class="col-md-6">  <label>Profile Name :</label> </div>
                        <div class="col-md-6">  <input placeholder="Enter Profile Name" class="form-control" name="edit_profile_name" id="edit_profile_name">
                        </div>
                    </div>  /.form-group 
                    <input type="hidden" name="adminuser_id" id="adminuser_id_1" style="visibility:hidden;" readonly/>
...
<!--<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="view_profile" class="modal fade" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times;</button>
                <h4 id="myModalLabel" class="modal-title">View Profile</h4>
            </div>
