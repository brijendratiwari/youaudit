...
<div class="box">
    <div class="heading">
        ...
        if (count($arrResults) > 0) {
            ?>
            <div class="buttons">
                <a target="_blank" href="<?php echo site_url('reports/createPdf/' . $strPdfUrl . (int) $location) . '/' . $startDate . '/' . $endDate . '' ?>" class="button">Download as a PDF</a>
    ...
    <div class="box_content">
        <div class="content_main">
            ...
            if (count($arrResults) > 0) {
                ...
                <table class="list_table" id="log_table">
                    <thead>
                        <tr>
    <?php
...
<script type="text/javascript" language="javascript" class="init">
          var rowCount = $('#list_tbody tr').length;
                    $('#pagination_ctrl').smartpaginator({totalrecords: rowCount, recordsperpage: 15, initval: 0, next: 'Next', prev: 'Prev', first: 'First', last: 'Last', theme: 'black', datacontainer: 'list_tbody', dataelement: 'tr', length: 3});
</script>