...
<ul class="field" id="item_data_holder">
    ...
    <li><h3>Quantity</h3><?php echo $arrItem['quantity']; ?></li>
...
<ul id="item_data_options_holder">
    ...
    <?php } ?>
    <?php if($arrItem['supplier'] != NULL) { ?>
        <li class="arrow"><a href="#" onclick="isaSuppliers_getSupplier(<?php echo $arrItem['supplier']; ?>);"><img src="img/icon-bloke.png" width="29" class="ico">View Supplier</a></li>
    <?php } ?>
