...
<input type="hidden" name="locationdata_location_id" id="locationdata_location_id" value="<?php echo $arrLocation['id']; ?>" />
<input type="hidden" name="locationdata_location_name" id="locationdata_location_name" value="<?php echo $arrLocation['name']; ?>" />
