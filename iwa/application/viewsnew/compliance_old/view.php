<div class="heading">
    ...
    <div class="buttons">
        <a href="<?php  echo site_url('/fleet/addvehicle');  ?>" class="button">Add A Vehicle</a>
    </div>           
</div>
<div id="content">
    <!--<ul id="breadcrumb">
    ...
    <div class="box">
        <div class="heading">
            ...
            <div class="buttons">
                <a href="<?php echo site_url() . '/compliance/edit/' . $test['test_type_id']; ?>" class="button">Edit Compliance Check</a>            
            </div>
        </div>
