...
//                {
//                    $('#location_msg' + n).css('display', 'block');
//                    $('#location_msg' + n).addClass('errors');
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-striped table-bordered table-hover reference" id="multiple_user">
                        ...
                        <tbody id="tbody_multiple_cat">
                            <tr>
                                <td><input type="text" data=""  class="form-control multicat" name="location_name_1" id="location_name_1" placeholder="Enter Location Name" required="">
                                    <!--<div id="location_msg1">Location Name is Required</div>-->
                                </td>
                                <td><input type="text" data=""  class="form-control multicat"  name="qrcode_1" id="qrcode_1" placeholder="Enter QR Code"></td>
                                <td><select name="site_name_1" id="site_name_1" class="form-control multiemail" onchange="checksite(this);">
                                    ...
                                    <div id="error_msg1">A LOCATION MUST BE ALLOCATED TO A SITE</div>
                                </td>
                            ...
                            <tr id="row_1" style="display:none">
                                <td><input type="text" data="" class="form-control multicat"  name="location_name_" id="location_name_" placeholder="Enter Location Name"> <div id="location_msg">Location Name is Required</div></td>
                                <td><input type="text" data=""  class="form-control multicat"  name="qrcode_" id="qrcode_" placeholder="Enter QR Code" required=""> </td>
