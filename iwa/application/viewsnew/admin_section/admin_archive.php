...
<script>
    $(document).ready(function() {
        ...
        var supplier = $("#restore_supplier").DataTable({
            "ordering": true,
            "aLengthMenu": [[5, 10, 15, -1], [5, 10, 15, "All"]],
            "iDisplayLength": 5,
            "bDestroy": true, //!!!--- for remove data table warning.
            "aoColumnDefs": [
                ...
                {"sClass": "eamil_conform aligncenter", "bSortable": true, "aTargets": [6]},
                {"sClass": "eamil_conform aligncenter", "bSortable": true, "aTargets": [7]},
                {"sClass": "eamil_conform aligncenter", "bSortable": true, "aTargets": [8]},
                {"sClass": "eamil_conform aligncenter", "bSortable": true, "aTargets": [9]},
                {"sClass": "eamil_conform aligncenter", "bSortable": true, "aTargets": [10]},
                {"sClass": "eamil_conform aligncenter", "bSortable": true, "aTargets": [11]},
                {"sClass": "eamil_conform aligncenter", "bSortable": true, "aTargets": [12]},
                {"sClass": "eamil_conform aligncenter", "bSortable": true, "aTargets": [13]},
                {"sClass": "eamil_conform aligncenter", "bSortable": true, "aTargets": [14]}
            ]}
        );
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel-body multiadd">
            ...
            <div class="table-responsive">
                <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
                    <table id="restore_supplier" class="table table-striped table-bordered table-hover" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>Company Name</th>
                                <th>Type</th>
                            ...
                            if (!empty($suppliers)) {
                                foreach ($suppliers as $supplier) {
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="action-w"><a href=" <?php echo base_url('admin_section/restoresupplier/' . $supplier['supplier_id']); ?>"  title="Restore"><i class="fa fa-mail-reply franchises-i"></i></a>Restore</span></td></tr>
                                                    <?php
                                                }
                                            }
                                            ?>
