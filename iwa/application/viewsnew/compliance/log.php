            ...
            <table id="due_table" class="list_table">
                ...
                <tbody>
                    ...
                    $missedDaysArray = array(1=>1,7=>7,31=>31,90=>31,121=>45,182=>45,365=>60,730=>60,1095=>60);
                        ...
                        foreach ($item_dueTests['tests'] as $test) {
//                            var_dump($test);
                            $overdue = false;
                            $day_remain = '';
...
//                                            echo $diff->format('%a').', '.$day_remain.', '.date('d/m/Y', $test['due_ts']).'<br>';
                            ...
                            <tr class="comRow <?php if($day_remain == ''){ echo 'remove';} if ($overdue) { print 'overDueRow'; }?>" data-sort="<?php if ($overdue) { print 0; }else{ print $sort;}?>" data-testdays="<?php print $test['test_days'];?>" data-testfreq="<?php print $test['test_type_frequency'];?>" >
                                ...
                                <td><?php print $item_dueTests['item']->barcode; ?> </td>
                                <td><?php print $item_dueTests['item']->manufacturer; ?></td>
                                <td><?php print $item_dueTests['item']->model; ?></td>
                                <td><?php print $item_dueTests['item']->categoryname; ?> </td>
                                <td><?php print $item_dueTests['item']->owner; ?></td>
                                <td><?php print $item_dueTests['item']->location; ?></td>
                                <td><?php print $item_dueTests['item']->site; ?></td>
                                <td hidden=""><?php print $test['test_type_id'] ?></td>
                                <td hidden=""><?php print $item_dueTests['item']->itemid; ?></td>
                                ...
                                <td hidden=""><?php print $item_dueTests['item']->categoryid; ?></td>
                                <td class="right action makeComTd <?php if($overdue == FALSE && $sort > 1){ echo 'disableCom'; }?>"><a style="font-size: 15px;padding: 5px;" class="doComplianceLink" href="#" data-backdrop="static" data-toggle="modal"><img width="30px" src="/img/complaince_check.png" alt="Complete Check"></a></td>
                            </tr>
        ...
        <div class="modal fade" id="complianceModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="compliance_form" action="<?php echo base_url() ?>compliance/makeComplianceCheckItem" method="post">
                        ...
                        <div class="modal-body">
                            <table class="list_table">
                                ...
                                <input hidden="" name="log_page" id="" value="1">
