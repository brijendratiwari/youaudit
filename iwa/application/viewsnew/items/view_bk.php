...
<div class="heading">
    <h1><?php echo $objItem->manufacturer; ?> <?php echo $objItem->model;
?></h1>
    <div class="buttons">
        <?php
        //if ($objItem->siteid == 0)
        ...
        //}
        ?>
        <a href="<?php echo site_url('/compliance/log/' . $objItem->itemid . '/'); ?>" class="button">Log Compliance Check</a>
        ...
        if ($arrSessionData['objSystemUser']->levelid > 2) {
            if (($objItem->mark_deleted == 0) && ($objItem->mark_deleted_2 == 0)) {
                ?>  <a href="<?php echo site_url('/items/markdeleted/' . $objItem->itemid); ?>" class="button">Remove item</a><?php
            }
        }

        if ($arrSessionData['objSystemUser']->levelid > 1) {
            ?>
            <a id="item_edit" class="button">Edit item</a>
            <div style="float: right; margin-right: 5px;">
                <a onclick="$('#itemedit').submit();" class="button update" style="display: none;">Save</a>
            </div>               
            <?php
        }
        ?>
...
<div class="box_content">
    ...
    <div class="tabs">
        <a href="#first_table">Item Details</a>
        <a href="#second_table">Item History</a>
        <a href="#fourth_table">Item Fault History</a>
        <?php if ($this->session->userdata('objSystemUser')->compliance == 1) { ?>
            <a href="#third_table">Compliance History</a>
        <?php } ?>
        <a href="#pat_table">Item Pat History</a>  
    </div>
                    ...
                    <div class="table-responsive" id="view_itemdetails">
                        <table class="table">
                            <tbody>
                                ...
                                <tr><td>Notes</td>
                                    <td><textarea placeholder="Enter Notes" class="form-control" name="item_notes" value="<?php echo $objItem->notes; ?>" id="notes" cols="10" rows="2" disabled><?php echo $objItem->notes; ?></textarea></td></tr>
                            </tbody>
                        </table>
                    </div>  
    ...
    <!--                        <tr>
                            ...
                            if (count($arrCustomFields) > 0) {
                                foreach ($arrCustomFields as $custom_field) {
                                    ?>
                                    <tr id="custom_fields">
                                        <td><strong><?= $custom_field->field_name ?></strong></td>
                                        <td><input type="text" name="custom_fields" value="<?= $custom_field->content ?>" disabled></td>
                                    </tr>
                                    <?php
                                }
                            }
...
<!--                        <tr> <td></td>
                            <td><input placeholder="Enter Asset Type" class="form-control" name="asset_type" id="asset_type" type="text" value="" disabled> 
                            </td> </tr> -->
                    ...
                    <table class="table" >
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input class="form-control col-lg-10" name="compliance_date" id="compliance_date" type="text" value="12/06/2014" disabled></td>
                            </tr>
                            <tr>
