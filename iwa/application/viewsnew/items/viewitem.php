<div class="row col-lg-12">
    <?php $logo = 'logo.png'; ?>
    <div class='logo_cls'><img alt='Youaudit' src='<?php echo base_url('brochure/logo/' . $logo); ?>'></div>
</div>
<div id="wrapper"><div id="content"><div class="box">
            <div id="first_table" class="content_main">
                ...
                <div class="row">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr class="tb_header">
                                        ...
                                        <td style="width: 50%"> <div style='font-weight: bold'>
                                                Item Details
                                            </div></td>
                                        <td></td>
                                    </tr>
                    ...
                    <div class="col-lg-4"><table class="table">
