...
?>
    <li id="location_audit_item_<?php echo $check->id; ?>" style="background: #EF8686 url('img/icon-cross-shim.png') center right no-repeat">
        ...
        echo $check->check_name.": ".$check->check_description; ?></a></li>
        <li id="linenotes_<?php echo $check->id; ?>">Please enter note: <input id="notes_<?php echo $check->id; ?>" style="width: 400px;"/></li>
<?php
}
?>
</ul>
